...
## Project Structure
    ...
    ├── ideapros_llc_option_32153  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_option_32153`
...
2. Clone this repo and `cd ideapros_llc_option_32153`
